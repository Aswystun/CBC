...
# Output recipes with total_meat == 0 to rejects.csv
...
# This gave me a parsed_test.csv with 15,899 recipes with meat emissions, and a rejects.csv with 3,059 recipes with no meat emissions.
# I went back to 03b_unit_map_creation.py to add more volume units to exclude, for 07d script.
